...
KatOS requires a x86_64 CPU, and at least 128MB of RAM. To install KatOS, 300MB of storage space is required and a 64-bit EFI/UEFI motherboard (BIOS support is possible with the use of KatOS's External Init).
