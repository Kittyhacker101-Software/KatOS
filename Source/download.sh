...
wget http://nl.alpinelinux.org/alpine/latest-stable/main/x86_64/apk-tools-static-2.7.4-r0.apk
wget http://nl.alpinelinux.org/alpine/latest-stable/main/x86_64/busybox-1.26.2-r9.apk
wget http://nl.alpinelinux.org/alpine/latest-stable/main/x86_64/musl-1.1.16-r14.apk
