...
wget http://nl.alpinelinux.org/alpine/latest-stable/main/x86_64/apk-tools-2.7.2-r0.apk
wget http://nl.alpinelinux.org/alpine/latest-stable/main/x86_64/apk-tools-static-2.7.2-r0.apk
wget http://nl.alpinelinux.org/alpine/latest-stable/main/x86_64/busybox-1.26.2-r5.apk
